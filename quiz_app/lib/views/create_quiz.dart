...
class _CreateQuizState extends State<CreateQuiz> {
  ...
  createQuizOnline() {
    if (_formKey.currentState!.validate()) {
      ...
      databaseService.addQuizData(quizMap, quizId).then((value) => setState(() {
            _isLoading = false;
              ...
              child: Container(
                ...
                child: Column(
                  children: [
                    ...
                    //   decoration:
                    //       InputDecoration(hintText: "Enter Quiz Duration"),
                    //   onChanged: (val) {
                    //     quizDuration = val as int;
                    //   },
                    // ),
                    Spacer(),
                    GestureDetector(
